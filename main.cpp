...
void Error(U32 expected, SU32 result, U32 linenumber)
{
    ...
    {
        error_count++;
        printf("Test failed at line %d! expected: %d, result: %d\n", linenumber, expected, r);
    }
}
...
void TestSoftUintDivision(U32 x, U32 y, U32 linenumber)
{
    U32 x0 = x;
    U32 y0 = y;
    SU32 x1 = x;
...
#define TEST_SOFT_UINT_DIVISION(x, y) TestSoftUintDivision((x), (y), __LINE__)
...
int main (int argc, char **argv)
{
    ...
    TEST_SOFT_UINT_DIVISION(5, 1);
    TEST_SOFT_UINT_DIVISION(1, 5);
    TEST_SOFT_UINT_DIVISION(0, 1);
    TEST_SOFT_UINT_DIVISION(1, 1);
    TEST_SOFT_UINT_DIVISION(5, 5);
    TEST_SOFT_UINT_DIVISION(3429, 432);
    TEST_SOFT_UINT_DIVISION(1234, 1235);
    TEST_SOFT_UINT_DIVISION(0xffffffff, 0xffffffff);
    TEST_SOFT_UINT_DIVISION(0xffffffff, 1);
    TEST_SOFT_UINT_DIVISION(0xffffffff, 0x0000ffff);
    TEST_SOFT_UINT_DIVISION(1, 0xffffffff);
